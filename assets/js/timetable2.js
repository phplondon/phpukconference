...
var wordDay_sun = "Option 1";
var wordDay_mon = "Option 2";
var wordDay_tue = "Option 3";
var wordDay_wed = "Option 4";
var wordDay_thu = "-";
var wordDay_fri = "-";
var wordDay_sat = "-";
// ===============================
...
function getHeight(start_time, end_time) {
	return parseInt((calHour(end_time) - calHour(start_time)) * 41, 10); // 1 cell = 101px;
}
...
function timetableWeek(el, tiva_timetables, firstDayWeek) {
	...
	if (date_start == 'sunday') {
		wordDay = new Array(wordDay_sun, wordDay_mon, wordDay_tue, wordDay_wed);
		dayArr = new Array("sunday", "monday", "tuesday", "wednesday");
...
jQuery(document).ready(function(){
	jQuery('.tiva-timetable2').each(function(index) {
